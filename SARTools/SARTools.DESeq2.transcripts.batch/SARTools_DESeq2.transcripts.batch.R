...
workDir <- "/Users/jordansimpson/Documents/Data Analysis/RNASeqProject/SARTools/SARTools.DESeq2.transcripts.batch"      # working directory for the R session

projectName <- "SARTools.DESeq2.transcripts.batch"                         # name of the project
author <- "Jordan Simpson"                                # author of the statistical analysis/report
